...
@section('content')
                    ...
                    <div class="cyber-cart-items">
                        ...
                        <div class="cyber-cart-item" data-aos="fade-up">
                            <div class="cyber-cart-item-image">
                                <img src="{{ asset($item->product->imagepath) }}" alt="{{ $item->product->name }}" class="cyber-hover-glow">
                            ...
                            <div class="cyber-cart-item-quantity">
                                <div class="cyber-quantity-selector">
                                    <button class="cyber-qty-btn minus" data-item="{{ $item->id }}">-</button>
                                    <span class="cyber-qty-value">{{ $item->quantity }}</span>
                                    <button class="cyber-qty-btn plus" data-item="{{ $item->id }}">+</button>
                                </div>
                            </div>
                            <div class="cyber-cart-item-total">
                                <div class="cyber-total-price">${{ number_format($item->quantity * $item->product->price, 2) }}</div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="cyber-cart-summary">
                        ...
                        <div class="cyber-summary-details">
                            ...
                            <div class="cyber-total-row">
                                <span>Total</span>
                                <span class="cyber-grand-total">${{ number_format($cartProducts->sum(function ($item) { return $item->product->price * $item->quantity; }), 2) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="cyber-promo-section">
                            <div class="cyber-promo-input">
                                ...
                                <button class="cyber-promo-btn">APPLY</button>
                            </div>
                        </div>
    ...
    <div class="cyber-mini-cart">
        ...
        <div class="cyber-mini-cart-total">${{ number_format($cartProducts->sum(function ($item) { return $item->product->price * $item->quantity; }), 2) }}</div>
    ...
    <style>
        ...
        .cyber-delete-btn, .cyber-wishlist-btn {
            width: 25px;
            height: 25px;
            border-radius: 50%;
            display: flex;
        ...
        .cyber-delete-btn:hover, .cyber-wishlist-btn:hover {
            transform: scale(1.1);
        ...
        .cyber-cart-item-price, .cyber-cart-item-quantity, .cyber-cart-item-total {
            display: flex;
            align-items: center;
            justify-content: center;
        }
        ...
        .cyber-checkout-btn, .cyber-previous-orders-btn {
            display: flex;
            align-items: center;
            justify-content: space-between;
            padding: 15px 20px;
