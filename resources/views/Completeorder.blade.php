                            ...
                            <form action="/StoreOrder" method="POST" id="store-order" name="store-order">
                                        ...
                                        <div class="cyber-accordion-body">
                                            <div class="cyber-billing-form">
                                                ...
                                                <div class="cyber-form-group">
                                                    ...
                                                    <input type="email" required placeholder="{{ Auth::user()->email }}"
                                                        id="email" name="email" class="cyber-input" readonly
                                                ...
                                                <div class="cyber-form-group">
                                                    <div class="cyber-input-icon"><i class="fas fa-map-marker-alt"></i>
                                                    </div>
                                                ...
                                                <div class="cyber-form-group">
                                                    <div class="cyber-input-icon"><i class="fas fa-comment-dots"></i>
                                                    </div>
                                ...
                                <div class="cyber-accordion-card" data-aos="fade-up">
                                    <div class="cyber-accordion-header" id="cyberHeadingPayment">
                                        <button class="cyber-accordion-btn collapsed" type="button"
                                            data-toggle="collapse" data-target="#cyberCollapsePayment"
                                            aria-expanded="false" aria-controls="cyberCollapsePayment"
                                            ...
                                            <div id="card-form" style="display:none; margin-top:20px;">
                                                <div class="cyber-form-group">
                                                    ...
                                                    <input type="text" name="card_number" placeholder="CARD NUMBER"
                                                        class="cyber-input" value="{{ old('card_number') }}">
                                                    <div class="cyber-input-underline"></div>
                                                    <span class="cyber-error">
                                                        @error('card_number')
                                                            {{ $message }}
                                                ...
                                                <div class="cyber-form-row">
                                                    <div class="cyber-form-group">
                                                        <div class="cyber-input-icon"><i class="fas fa-calendar-alt"></i>
                                                        </div>
                                                        <input type="text" name="expiry_date" placeholder="MM/YY"
                                                            class="cyber-input" value="{{ old('expiry_date') }}">
                                                        <div class="cyber-input-underline"></div>
                                                        <span class="cyber-error">
                                                            @error('expiry_date')
                                                                {{ $message }}
                                                    ...
                                                    <div class="cyber-form-group">
                                                        ...
                                                        <input type="text" name="cvv" placeholder="CVV"
                                                            class="cyber-input" value="{{ old('cvv') }}">
                                                        <div class="cyber-input-underline"></div>
                                                        <span class="cyber-error">
                                                            @error('cvv')
                                                                {{ $message }}
                                                ...
                                                <div class="cyber-form-group">
                                                    ...
                                                    <input type="text" name="card_name" placeholder="CARDHOLDER NAME"
                                                        class="cyber-input" value="{{ old('card_name') }}">
                                                    <div class="cyber-input-underline"></div>
                                                    <span class="cyber-error">
                                                        @error('card_name')
                                                            {{ $message }}
                                ...
                                <div class="cyber-accordion-card" data-aos="fade-up">
                                    <div class="cyber-accordion-header" id="cyberHeadingThree">
                                        <button class="cyber-accordion-btn collapsed" type="button"
                                            data-toggle="collapse" data-target="#cyberCollapseThree"
                                            aria-expanded="false" aria-controls="cyberCollapseThree"
                                            style="cursor: default">
                                                        ...
                                                        @if ($discount > 0)
                                                            <div class="cyber-total-row">
                                                                ...
                                                                <span style="color: red">-
                                                                    {{ number_format($discount, 2) }} Dh</span>
                                                            </div>
                                                        @endif
                                                        <div class="cyber-grand-total-row">
                                                            <span>GRAND TOTAL</span>
                                                            <span class="cyber-grand-total">{{ number_format($total, 2) }}
                                                                Dh</span>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        regionSelect.addEventListener("change", function() {
                            ...
                            if (selectedRegionName) {
                                ...
                                const cities = data.cities.data.filter(city => {
                                    const region = data.regions.data.find(r => r.id === city
                                        .region_id);
