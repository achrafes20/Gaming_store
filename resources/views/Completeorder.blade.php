...
@section('content')
                                            ...
                                            <form action="/StoreOrder" method="POST" id="store-order" name="store-order">
                                                ...
                                                <div class="cyber-form-group">
                                                    ...
                                                    <input type="text" required placeholder="DELIVERY ADDRESS" id="address"
                                                        name="address" class="cyber-input">
                                                    <div class="cyber-input-underline"></div>
                                                </div>
    ...
    <style>
        ...
        .cyber-input-underline, .cyber-textarea-underline {
            position: absolute;
            bottom: 0;
            left: 0;
            width: 0;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setInterval(function() {
                ...
                accordionCards.forEach((card, index) => {
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            card.style.boxShadow = '0 5px 15px rgba(0, 240, 255, 0.1)';
                        }, 1000);
                    }, index * 300);
                });
            }, 8000);
            ...
            inputs.forEach(input => {
                input.addEventListener('focus', function() {
                    this.parentElement.querySelector('.cyber-input-icon').style.color = 'var(--cyber-organic)';
                });

                input.addEventListener('blur', function() {
                    this.parentElement.querySelector('.cyber-input-icon').style.color = 'var(--cyber-primary)';
                });
            });
        });
    </script>
