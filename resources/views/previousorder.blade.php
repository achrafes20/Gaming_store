...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <div class="cyber-hero-text">
                        ...
                        <h1 class="cyber-title">PREVIOUS ORDERS</h1>
    ...
    <div class="cyber-orders-section">
        <div class="container">
            ...
            <div class="cyber-summary-row">
                <span>Discount </span>
                <span style="color: red">- {{ number_format($item->discount, 2) }} Dh</span>
            </div>
            @endif
                                            <div class="cyber-total-row">
                                                ...
                                                @if($item->discount > 0)
                                                <span
                                                    class="cyber-total">{{number_format( $item->total - $item->discount,2) }} Dh</span>
                                                @else
                                                <span
    ...
    @push('styles')
        <link rel="stylesheet" href="{{ asset('assets/css/previousorder.css') }}">
    @endpush
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/js/previousorder.js') }}"></script>
