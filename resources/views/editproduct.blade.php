...
@section('content')
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="cyber-form-container">
                        ...
                        <div class="cyber-form-body">
                            <form method="POST" enctype="multipart/form-data" action="/storeproduct" id="cyber-product-form">
                                @csrf()
                                    ...
                                    <div class="cyber-form-group">
                                        <div class="cyber-input-container">
                                            <input type="number" placeholder="QUANTITY" name="quantity"
                                                id="quantity" value="{{ $product->quantity }}" class="cyber-input">
                                            <div class="cyber-input-border"></div>
                                            <div class="cyber-input-icon">
                                ...
                                <div class="cyber-form-group">
                                    <div class="cyber-file-container">
                                        ...
                                        <div class="cyber-file-preview">
                                            <img src="{{ asset($product->imagepath) }}" alt="Current Image" class="cyber-current-img">
                                        </div>
                                    </div>
                                    <span class="cyber-error">
                                        @error('photo')
    ...
    <style>
        ...
        :root {
            ...
            --cyber-code-bg: rgba(15, 15, 35, 0.9);
        }
                    ...
                    if (this.files && this.files[0]) {
                        ...
                        reader.onload = function(e) {
                            ...
                            if (img) {
                                ...
                                filePreview.innerHTML = '<img src="' + e.target.result + '" alt="Preview" class="cyber-current-img">';
                            }
                        }
